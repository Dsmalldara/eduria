...
import { FileTextIcon, ImageIcon, FileIcon, VideoIcon, PlusIcon, SearchIcon, BookOpenIcon, DownloadIcon } from 'lucide-react';
interface ResourcesProps {
  userType: string;
}
export default function Resources({userType}: ResourcesProps) {
